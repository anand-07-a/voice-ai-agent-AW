...
Add a [link](https://markdown-viewer.convertaudiofiles.com) to important resources.

Embed an image:
![Markdown Logo](/img/icon-128.png)
...
This is a fully client-side application. Your content stays secure on your device.